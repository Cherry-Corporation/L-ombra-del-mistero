...
define config.name = _("L'ombra del mistero")
...
define build.name = "l'ombra-del-mistero"
...
define config.save_directory = "lombra-del-mistero"
...
define config.window_icon = "gui/themannusicon.png"
